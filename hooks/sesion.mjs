...
function listaSkills() {
  try {
    ...
    return "/fabrica, /razonar, /complejo, /ubicar, /grafo, /oficina, /spec, /plan-ceo, /plan-ing, /plan-diseno, /diseno, /design-review, /autoplan, /construir, /revisar, /investigar, /qa, /qaonline, /scrape, /autenticar, /shipear, /retro, /memoria, /seguridad, /guardian, /legal, /docs, /contexto, /segunda-opinion, /pruebas-afectadas, /desplegar, /canario, /benchmark";
  }
}
